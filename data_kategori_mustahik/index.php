      ...
      <table class="table align-middle table-bordered table-hover">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <a href="edit.php?id_kategori=<?= $mtk["id_kategori"]; ?>" type="button" class="btn btn-success btn-sm"><i class="fa fa-pencil-square-o"></i></a>
              <a href="hapus.php?id_kategori=<?= $mtk["id_kategori"]; ?>" type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a>
            </td>
          </tr>
          <?php $i++; ?>
        <?php endforeach; ?>
