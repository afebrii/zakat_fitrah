...
if (isset($_POST["submit"])) {
  if (tambah($_POST)) {
    echo "
    <script>
    alert ('Distribusi Zakat Fitrah Mustahik Berhasil Ditambahkan');
    ...
    echo "
    <script>
    alert ('Distribusi Zakat Fitrah Mustahik Gagal Ditambahkan');
    document.location.href = 'index.php';
    </script>
    ";
  }
...
<body>
  ...
  <div class="container">
    <h1 class="mt-4">Tambah Distribusi Mustahik Lainnya</h1>

    <form action="" method="post">
      <div class="mb-3 mt-4 row">
        <label for="nama_mustahiklainnya" class="col-sm-2 col-form-label">Nama</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" id="nama_mustahiklainnya" placeholder="Masukkan Nama" name="nama_mustahiklainnya">
        </div>
      </div>
      <div class="mb-3 row">
        <label for="kategori" class="col-sm-2 col-form-label">Kategori</label>
        <div class="col-sm-10">
          <select class="form-select" aria-label="Default select example" name="kategori_mustahiklainnya">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-10">
          <select class="form-select" aria-label="Default select example" name="hak_mustahiklainnya">
