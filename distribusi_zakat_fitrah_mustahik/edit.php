...
$mustahik_lain = query("SELECT * FROM mustahik_lainnya WHERE id_mustahiklainnya = $id")[0];
...
<body>
  ...
  <div class="container">
    <h1 class="mt-4">Edit Distribusi Mustahik Lainnya</h1>

    <form action="" method="post">
      <input type="hidden" name="id_mustahiklainnya" value="<?= $mustahik_lain["id_mustahiklainnya"] ?>">
      <div class="mb-3 mt-4 row">
        <label for="nama_mustahiklainnya" class="col-sm-2 col-form-label">Nama</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" id="nama_mustahiklainnya" placeholder="Masukkan Nama" name="nama_mustahiklainnya" value="<?= $mustahik_lain["nama_mustahiklainnya"] ?>">
        </div>
      </div>
      <div class="mb-3 row">
        <label for="kategori" class="col-sm-2 col-form-label">Kategori</label>
        <div class="col-sm-10">
          <select class="form-select" aria-label="Default select example" name="kategori_mustahiklainnya" value="<?= $mustahik_lain["kategori_mustahiklainnya"] ?>">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-10">
          <select class="form-select" aria-label="Default select example" name="hak_mustahiklainnya" value="<?= $mustahik_lain["hak_mustahiklainnya"] ?>">
