...
<body>
  ...
  <div class="container">
    <h1 class="mt-4">Distribusi Zakat Fitrah Warga</h1>
      ...
      <table class="table align-middle table-bordered table-hover">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <a href="edit.php?id_mustahikwarga=<?= $warga["id_mustahikwarga"]; ?>" type="button" class="btn btn-success btn-sm"><i class="fa fa-pencil-square-o"></i></a>
              <a href="hapus.php?id_mustahikwarga=<?= $warga["id_mustahikwarga"]; ?>" type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a>
