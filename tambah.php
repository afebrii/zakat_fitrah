...
<body>
  ...
  <div class="container">
    <h1 class="mt-4">Tambah Data Muzakki</h1>

    <form action="" method="post">
      <div class="mb-3 mt-4 row">
        <label for="nama_muzakki" class="col-sm-2 col-form-label">Nama</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" id="nama_muzakki" placeholder="Masukkan Nama" name="nama_muzakki">
        </div>
      </div>
      <div class="mb-3 row">
      ...
      <div class="mb-3 row">
        ...
        <div class="col-sm-10">
          <select class="form-select" aria-label="Default select example" name="keterangan">
            ...
            <option value="Anak dan Istri">Anak dan Istri</option>
          </select>
        </div>
      </div>
